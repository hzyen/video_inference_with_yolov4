...
#from utils.utils import finishedAlertEvent
...
def main(cfg):
    ...
    frameQ = queue.Queue()
    detectionQ = queue.Queue()
    # Define 2 events
    finishedCaptureEvent = threading.Event()
    finishedDetectionEvent = threading.Event()
    finishedWriteEvent = threading.Event()
